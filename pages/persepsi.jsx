  ...
  return (
    <div style={{ padding: '1rem' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap' }}>
        <TabelTopik topik="psKonsen" />
        <TabelTopik topik="psEkonomiLokal" />
        <TabelTopik topik="psLapanganKerja" />
        <TabelTopik topik="psLingkungan" />
        <TabelTopik topik="psKesmas" />
        <TabelTopik topik="psKepekaan" />
        <TabelTopik topik="psInfrastruktur" />
        <TabelTopik topik="psAdat" />
        <TabelTopik topik="psGotongRoyong" />
        <TabelTopik topik="psSikap" />
      </div>
      <br/>
      <div>
      </div>
