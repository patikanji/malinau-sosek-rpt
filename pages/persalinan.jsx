  ...
  return (
    <div style={{ padding: '1rem' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap' }}>
        <TabelTopik topik="persalinan" />
        <TabelTopik topik="asi" />
        <TabelTopik topik="rawatBayi" />
        <TabelTopik topik="rawatBayiInfo" />
        <TabelTopik topik="airBersih" />
        <TabelTopik topik="cuciTangan" />
        <TabelTopik topik="nyamuk3m" />
        <TabelTopik topik="bersayur" />
        <TabelTopik topik="olahraga" />
        <TabelTopik topik="merokok" />
      </div>
      <br/>
      <div>
      </div>
